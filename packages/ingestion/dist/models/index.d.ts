 ...
 */
export type ChangeSource = LocalGitSource | GitHubPRSource | UnknownSource;
 ...
 */
export type EvidenceSourceType = "function" | "type-decl" | "constant" | "route" | "diff-context" | "unknown";
/**
 ...
 */
export type EvidenceDiffRelation = "added" | "removed" | "context" | "surrounding";
/**
 ...
 */
export type IngestionWarningCode = "BINARY_FILE_SKIPPED" | "DIFF_PARSE_ERROR" | "EVIDENCE_EXTRACTION_FAILED" | "STAT_UNAVAILABLE" | "REF_NOT_FOUND" | "TRUNCATED_DIFF" | "UNKNOWN";
 ...
 */
export type FileLanguage = "typescript" | "javascript" | "python" | "go" | "rust" | "java" | "csharp" | "ruby" | "php" | "graphql" | "prisma" | "sql" | "json" | "yaml" | "toml" | "markdown" | "shell" | "dockerfile" | "config" | "test" | "unknown";
/**
 ...
 */
export type PriorityReason = "type-declarations-changed" | "api-routes-changed" | "auth-or-security-path" | "schema-file-changed" | "exports-changed" | "imports-changed" | "high-diff-volume" | "test-only-changes" | "config-only-changes" | "documentation-only" | "low-diff-volume";
/**
 ...
 */
export type PayloadTruncationCode = "SNIPPET_BUDGET_EXCEEDED" | "REQUIREMENT_TRUNCATED" | "FILE_SUMMARY_OMITTED" | "DIFF_BODY_STRIPPED";
